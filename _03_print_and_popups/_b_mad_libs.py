...
if __name__ == '__main__':
  ...
  # Get the player to enter an adjective
    simpledialog.askstring("Adjective", "Enter an adjective")
    # Get the player to enter a type of liquid
    simpledialog.askstring("Liquid", "Enter a type of liquid")

    # Get the player to enter a body part
    simpledialog.askstring("Body part", "Enter a body part")

    # Get the player to enter a verb
    simpledialog.askstring("Verb", "Enter a verb")

    # Get the player to enter a place
    simpledialog.askstring("Place", "Enter a Place")
